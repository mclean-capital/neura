...
export function ScreenShareToggle({ isActive, onToggle, disabled }: ScreenShareToggleProps) {
  return (
    <button
      className={`flex items-center gap-1.5 px-3.5 py-2 rounded-full bordertext-[0.8rem] cursor-pointer transition-all duration-200 disabled:opacity-40 disabled:cursor-default ${
        isActive

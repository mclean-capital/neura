/**
 * AudioWorklet processor that downsamples mic input to 24 kHz mono PCM (Int16).
 * Grok Voice Agent expects pcm16 at 24 kHz (OpenAI Realtime API default).
 * Sends chunks of ~200 ms (4800 samples at 24 kHz) to the main thread.
 */
class PCMProcessor extends AudioWorkletProcessor {
  constructor() {
    ...
    this.outputCount = 0;
    this.buffer = [];
    this.CHUNK = 4800; // 200 ms at 24 kHz
  }

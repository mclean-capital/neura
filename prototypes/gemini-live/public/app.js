...
// ── State ───────────────────────────────────────────────────────────────────
let ws = null;
let audioCtx = null; // mic capture context
let micStream = null;
let micSource = null;
...
// Transcript tracking (accumulate incremental updates)
  ...
  ws.onmessage = (e) => {
    ...
    switch (msg.type) {
      ...
      case 'interrupted':
        ...
        break;
      case 'turnComplete':
        // Finalize current messages so next transcript starts fresh
        currentUserMsg = null;
...
async function startMic() {
  ...
  // Connect: mic → processor → destination (processor outputs silence)
